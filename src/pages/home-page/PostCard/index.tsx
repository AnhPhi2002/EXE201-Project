        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {latestPosts.map((item) => (
              <div key={item._id} className="bg-white/30 rounded-lg shadow-lg overflow-hidden backdrop-blur-lg transition duration-300 transform hover:shadow-2xl hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-700 mb-4 line-clamp-3">{item.content.slice(0, 100)}...</p>
                  <button
