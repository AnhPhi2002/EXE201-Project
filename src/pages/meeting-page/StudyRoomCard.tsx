...
export const StudyRoomCard: React.FC<StudyRoomCardProps> = ({ post, onJoin }) => {
  return (
    <div className="bg-white/70 backdrop-blur-lg rounded-xl shadow-lg p-6 border border-white/20">
      <h1
        className="text-xl font-bold text-gray-800 mb-3 truncate"
        title={post.title} // Tooltip hiển thị nội dung đầy đủ
      >
        {post.title}
      </h1>
      ...
      <div className="min-h-[100px] mb-6">
        <p
          ...
          title={post.description} // Tooltip hiển thị nội dung đầy đủ
        >
          {post.description}
        </p>
      </div>
