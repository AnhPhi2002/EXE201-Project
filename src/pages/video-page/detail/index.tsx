...
const ForumPage: React.FC = () => {
  ...
  const initialArticles: Article[] = [
    { id: 1, code: "SE392", title: "How to improve React performance?", description: "Discussing best practices to optimize React applications...", author: 'Alice', date: '2024-09-10 10:00', bgColor: "#00FF75" },
    { id: 2, code: "IB101", title: "JavaScript: Hoisting vs Scoping", description: "An in-depth discussion on JavaScript hoisting and scoping...", author: 'Bob', date: '2024-09-11 14:15', bgColor: "#4DF4E7" },
    // Các bài viết khác...
  ];
          ...
          <div key={article.id} className="bg-white shadow-md rounded-lg p-6 relative">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center space-x-4">
                <div
                  className="text-black text-xl font-medium py-1 px-3 rounded-full"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Posted by {article.author} on {article.date}</p>
                </div>
              </div>
            </div>
