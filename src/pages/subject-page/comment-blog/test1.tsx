...
import { fetchCommentsBySubjectId, addComment, deleteComment, updateComment, replyToComment } from '@/lib/api/redux/commentSubjectSlice';
...
const CommentBlog: React.FC<CommentBlogProps> = ({ subjectId }) => {
